								...
								<form class="form-horizontal"  role="form" method="post" action="<?php echo base_url() . "Shops/update/" . $results[0]->s_id; ?>" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-md-3 img_container">
											...
											<img class="form-control" id="target1" alt="Click to Select Image" src="<?php if($results[0]->image1){ echo base_url()."uploads/shops/". $results[0]->image1; } else { echo base_url()."images/default.jpeg"; } ?>"/>
										</div>
										<div class="col-md-3 img_container">
											...
											<img class="form-control" id="target2" alt="Click to Select Image" src="<?php if($results[0]->image2){ echo base_url()."uploads/shops/". $results[0]->image2; } else { echo base_url()."images/default.jpeg"; } ?>"/>
										</div>
										<div class="col-md-3 img_container">
											...
											<img class="form-control" id="target3" alt="Click to Select Image" src="<?php if($results[0]->image3){ echo base_url()."uploads/shops/". $results[0]->image3; } else { echo base_url()."images/default.jpeg"; } ?>"/>
										</div>
										<div class="col-md-3 img_container">
											...
											<img class="form-control" id="target4" alt="Click to Select Image" src="<?php if($results[0]->image4){ echo base_url()."uploads/shops/". $results[0]->image4; } else { echo base_url()."images/default.jpeg"; } ?>"/>
										</div>
									</div>
